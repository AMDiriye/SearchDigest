            ...
            for (Method method : methods) {
                ...
                if (1 == args.length) {
                    ...
                    if (methodName.contains("set")) {
                        ...
                        Class arg = args[0];
                        if (methodName.contains("pageSize".toLowerCase())
                                && double.class.equals(arg)) {
                            method.invoke(obj, pageSize);
                        } else if (methodName.contains("threshold".toLowerCase())
                                && double.class.equals(arg)) {
                            method.invoke(obj, threshold);
                        } else if (methodName.contains("referrer".toLowerCase())
                                && String.class.equals(arg)) {
                            method.invoke(obj, referrer);
                        } else if (methodName.contains("allDividableNode".toLowerCase())
