...
/**
 * This class is the canonical component representing webpage elements
...
public class WebBlock {
		...
		//Box corresponds to DOM element
		private Box box = null;
		private List<WebBlock> children = null;
		private int id = 0;
		private int DegreeOfCoherence = 0;
		private int numImg = 0;
		private boolean isImg = false;
		private boolean isVisualWebBlock = false;
		private boolean containsTable = false;
		private int numParag = 0;
		private boolean isDivided = false;
		private boolean isDivisble = true;
		private String backGroundColor = null;
		private int frameSourceIndex = 0;
		private int sourceIndex = 0;
		private int tmpSrcIndex = 0;
		private int order = 0;
		private int textLen = 0;
		private int linkTextLen = 0;
		
		
		public WebBlock(){
			children = new ArrayList<WebBlock>();
		}
	
		public void setIsVisualWebBlock(boolean isVisualWebBlock){
			this.isVisualWebBlock = isVisualWebBlock;
			checkProperties();
		}

		public boolean isVisualWebBlock(){
			return isVisualWebBlock;
		}
		...
		{
			if (box.getNode().getNodeName().equals("img"))
				isImg = true;
			else
				isImg = false;
		}
