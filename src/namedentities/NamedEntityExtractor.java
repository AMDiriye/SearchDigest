...
public class NamedEntityExtractor {
	  ...
	  public static String[] NAME_TYPES = { "person", "money"};//, "location", "date", "time", "percentage", "money" };
      public static NamedEntityType[] ENTITY_TYPES = { NamedEntityType.PERSON,
                      NamedEntityType.MONEY};/*, 
                      NamedEntityType.LOCATION,NamedEntityType.DATE, 
                      NamedEntityType.TIME, NamedEntityType.PERCENTAGE, NamedEntityType.MONEY};*/
      ...
      public NamedEntityExtractor() 
      {
             ...
             // finders[5] = new NameFinderME(new TokenNameFinderModel(new FileInputStream("./data/en-ner-percentage.bin")));
              //money type
              finders[1] = new NameFinderME(new TokenNameFinderModel(new FileInputStream("./data/en-ner-money.bin")));
